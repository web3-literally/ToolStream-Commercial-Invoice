...
function GeneratePDFFromInvoice(data) {
    ...
    var InvoiceHeader = data[0].invoiceHeader;
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        var _InvoiceFooter = data[i].invoiceFooter;
        ...
        TotalNumberOfPackages += _InvoiceFooter.numberOfPackages;
        TotalValue += _InvoiceFooter.totalValue;
        TotalGrossWeight += _InvoiceFooter.totalWeight;
    }

    var InvoiceFooter = data[0].invoiceFooter;
    ...
    doc.autoTable({
        ...
        body: tableBody,
        columns: [{ header: 'OrderLine No', dataKey: 'OrderLineNo' }, { header: 'Quantity', dataKey: 'Units' }, { header: 'Product Code/SKU', dataKey: 'ProductSKU' }, { header: 'Description', dataKey: 'Description' }, { header: 'Country Of Origin', dataKey: 'CountryOfOrigin' }, { header: 'Tariff Number', dataKey: 'TariffNumber' }, { header: 'Line Price', dataKey: 'LinePrice' }, { header: 'Net Weight', dataKey: 'NetWeight' }]
    });
